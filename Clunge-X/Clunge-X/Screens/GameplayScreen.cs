...
namespace Clunge_X
{
    class GameplayScreen : GameScreen
    {
        ...
        private void DrawHud(SpriteBatch spriteBatch)
        {
            ...
            DrawShadowedString(spriteBatch, hudFont, "SCORE: " + level.Score.ToString(), hudLocation + new Vector2(0.0f, timeHeight * 1.2f), Color.Yellow);


            //draw lives
            for (int i = 0; i < level.Player.Lives; i++)
            {
                spriteBatch.Draw(level.Player.LifeTexture, new Rectangle(i * 20 + 10, 65, (int)(level.Player.LifeTexture.Width * .35), (int)(level.Player.LifeTexture.Height * .35)), Color.White);
            }
